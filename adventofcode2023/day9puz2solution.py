...
def get_previous_number_recurse(num_arr):
    ...
    recurse_delta = get_previous_number_recurse(delta_arr)

    return num_arr[0] - recurse_delta
...
if __name__ == "__main__":
    ...
    with open(file_name, 'r') as file_handle:
        for line in file_handle:
            ...
            next_number = get_previous_number_recurse(number_arr)
